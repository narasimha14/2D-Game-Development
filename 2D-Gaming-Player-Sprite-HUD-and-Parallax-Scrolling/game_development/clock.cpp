...
//  IOManager::getInstance().printMessageAt("Project #4: The Jungle Book", pos[0]+ 320, pos[1]+5);
  IOManager::getInstance().printMessageAt("Narasimha Murthy's Project", pos[0]+ 320, pos[1]+5);
}
